...
Queue certification: certified — three current leaves are active; the actual ready queue contains exactly the one current leaf listed below and no stale work.
Claim queue: br ready -l ideal-2026-07 -t task
Current tasks: `bd-59co.2.2.9` (versioned cross-platform gate runner), `bd-59co.3.1.5` (owned Windows test-resource policy), and `bd-59co.3.15.6` (owned Excel64 VBE oracle supervisor).
Certified ready queue: `bd-59co.2.2.3`.
