...
Queue certification: certified — three current leaves are active; the actual ready queue contains exactly the four current leaves listed below and no stale work.
Claim queue: br ready -l ideal-2026-07 -t task
Current tasks: `bd-59co.2.2.9` (versioned cross-platform gate runner), `bd-59co.2.2.22` (VM3 foreign-object fixture provenance), and `bd-59co.3.1.5` (owned Windows test-resource policy).
Certified ready queue: `bd-59co.2.2.3`, `bd-59co.2.2.18`, `bd-59co.3.1.6`, and `bd-59co.3.15.4`.
