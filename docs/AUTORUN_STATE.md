...
- Active execution target is non-HAL hardening ladder `v167..v186`.
- Latest integrated gate artifact: `docs/evidence/profiles/v166/integrated_gate.md`.
- Latest matrix artifact: `docs/evidence/profiles/v166/matrix_latest.csv`.
- Latest profile gate artifact: `docs/evidence/profiles/v166/gate_report.md`.
