...
Reply condition: only report back when `v36` gate is passed, or when all remaining progress is blocked by documented blockers.

Current checkpoint:
- Current stabilized scope is `mvp-full-coverage-perf-gate-v36`; active AutoRun target gate is `v36`.
