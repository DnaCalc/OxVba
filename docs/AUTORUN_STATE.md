...
Current tasks: `bd-59co.2.2.9` (versioned cross-platform gate runner), `bd-59co.3.1.5` (owned Windows test-resource policy), and `bd-59co.3.15.4` (Windows certification-case manifest).
