...
Current tasks: `bd-59co.2.2.9` (versioned cross-platform gate runner), `bd-59co.2.2.16` (transactional owning VbaRecord writes), and `bd-59co.3.1.5` (owned Windows test-resource policy).
