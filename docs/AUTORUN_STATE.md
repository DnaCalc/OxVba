...
- Active execution target is non-HAL hardening ladder `v171..v186` (after v167..v170 completion pass).
- Latest integrated gate artifact: `docs/evidence/profiles/v170/integrated_gate.md`.
- Latest matrix artifact: `docs/evidence/profiles/v170/matrix_latest.csv`.
- Latest profile gate artifact: `docs/evidence/profiles/v170/gate_report.md`.
