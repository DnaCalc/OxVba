...
Queue certification: certified — three current leaves are active; the actual ready queue contains exactly the six current leaves listed below and no stale work.
Claim queue: br ready -l ideal-2026-07 -t task
Current tasks: `bd-59co.2.2.9` (versioned cross-platform gate runner), `bd-59co.2.2.17` (borrowed carrier projection unwind safety), and `bd-59co.3.1.5` (owned Windows test-resource policy).
Certified ready queue: `bd-59co.2.2.3`, `bd-59co.2.2.14`, `bd-59co.2.2.18`, `bd-59co.2.2.22`, `bd-59co.3.1.6`, and `bd-59co.3.15.4`.
...
Last completed tasks: `bd-59co.2.2.16` closed after transactional VbaRecord/SAFEARRAY mutation and armed constructor-payload ownership passed controller checks, strict all-feature Clippy, full runtime tests, three Miri lanes and clean independent Sol review; borrowed raw-carrier projection unwind safety remains exact active successor `.17`. `bd-59co.2.2.8` remains closed after the digest-pinned Linux x64 CI contract, structural pending/sealed ledger mutation coverage, live official provenance checks and clean non-author review; exact baseline execution remains blocking under `.11`. `bd-59co.3.1.4` remains closed support-only after genuine loader-backed x64 PE/TLB admission, controller-owned digest binding, generalized fail-closed MSFT record parsing, 8 positive/54 mutation evidence and clean non-author review; all 57 artifacts/environments remain pending with no capability credit. Exact open successors `.9`, `.11`, `.17`, `.18`, `.22`, `.2.4.4`, and `bd-59co.2.7.2` own the portable gate runner, Linux execution, borrowed-carrier unwind safety, VMR05 provenance, VM3 fixture provenance, compiler UDT size/depth limits, and hidden object-carrier thread/apartment transit; no terminal row is closed by these slices.
