...
- bounded ambiguous/missing non-authoritative object-valued default-member read-assignment diagnostics on the source-resolution path for explicit `Set` to scalar targets across bare, zero-arg parenthesized, and indexed syntax
