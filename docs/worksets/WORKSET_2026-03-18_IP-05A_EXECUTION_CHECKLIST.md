...
- [ ] Supported early-bound diagnostics for unresolved qualifiers, unsupported members, and unsupported shapes remain deterministic after the metadata handoff.
