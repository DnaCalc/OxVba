...
wrapper library row production was delivered by follow-up `bd-9xmu.5.9`.
...
were recovered on 2026-05-02; child workset 5 is recovered with VM/JIT,
wrapper EXE, and wrapper library producer evidence.
...
| 5 | `WORKSET_2026-04-30_REFERENCE_RUNNERS_AND_PERF_SCAFFOLD.md` | Standardize correctness/perf evidence for VM/JIT/wrappers/future native. | **Recovered complete:** VM/JIT, wrapper EXE, and wrapper library schema producers recovered/delivered. |
...
- VM/JIT, wrapper EXE, and wrapper library reference runners use the shared
  result schema.
