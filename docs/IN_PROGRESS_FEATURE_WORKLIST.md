...
3. bounded single-candidate fallback and bounded ambiguous-getter rejection now exist for native non-authoritative default members, but broader fallback/recovery parity is still open,
