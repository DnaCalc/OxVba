...
**Required for Initial Scope (5 gates total — 2 now closed, 3 still open):**
...
- [ ] **BLK-ORACLE-001** — Evidence gap. Need remaining Office/host capture matrix for `ODG-030`, `ODG-031`, and `ODG-045`.
