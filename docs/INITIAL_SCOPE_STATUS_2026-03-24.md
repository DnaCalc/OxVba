...
- [x] ODG-040 — Host extension modules. Still open, but the model boundary is enforced and a deterministic HAL project-catalog/reference mock exists; remaining work is adapter-backed host mutation plus oracle capture.
...
- [ ] INTP-013 — Host extension module lifecycle. Blocked on the remaining ODG-040 adapter-backed host mutation and oracle capture work.
