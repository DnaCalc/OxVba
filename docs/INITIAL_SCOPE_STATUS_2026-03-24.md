...
**Required for Initial Scope (5 gates total — 3 now closed, 2 still open):**
...
- [ ] **BLK-ORACLE-001** — Evidence gap. Need remaining Office/host capture matrix for `ODG-030` and `ODG-031`.
