...
- `DIV-0005` — internal class/object lifetime teardown `Class_Terminate` parity is closed for current VM3 internal project objects; live COM server/export release behavior remains separate `IP-06` scope (closed)
