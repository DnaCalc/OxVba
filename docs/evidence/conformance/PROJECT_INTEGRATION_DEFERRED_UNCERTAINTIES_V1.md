...
| Host project extension module lifecycle (open host project model) | Deferred/in-progress | `ODG-040`, `CCT-042`, `INTP-013` | Project-model extension legality is enforced and a deterministic HAL project-catalog/reference mock exists; remaining work is adapter-backed host project mutation capability plus oracle-backed host behavior capture. |
