...
| Host project extension module lifecycle (open host project model) | Deferred/in-progress | `ODG-040`, `CCT-042`, `INTP-013` | Project-model extension legality is now enforced; remaining work requires HAL-backed host project catalog/mutation capabilities and oracle-backed host behavior capture. |
