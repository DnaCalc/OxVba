...
| ID-008 | COM early oracle parity | Excel/VBA parity for `As New` activation timing, dual-interface fallback behavior, and typelib version/broken-reference handling is deferred. | These behaviors are host-dependent and need empirical oracle capture before strong parity claims. | ODG-044, ODG-045, ODG-046 |
