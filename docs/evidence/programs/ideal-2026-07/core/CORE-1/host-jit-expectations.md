...
- `vm3_golden_snapshot` remains blocked at
  ...
  that row. Exact delivery owner `bd-59co.2.2.18` must adjudicate fixture
  legality and repair executable array coverage or UTF-8/LF/CRLF provenance
  before the aggregate golden can pass.
- Broad strict Clippy remains independently blocked by the existing
  ...
  Clippy for the touched HAL and host crates is green. Exact low-risk delivery
  owner `bd-59co.2.2.19` preserves the `Bits64` default while removing that
  blocker.
