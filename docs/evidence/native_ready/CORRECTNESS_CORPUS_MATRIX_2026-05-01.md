...
| `NR-ORACLE-001` | oracle-foldback | `oracle_packets/oracle_numeric_coercion_001.bas` | selected numeric/coercion rows under Office/VBA | Captured output per packet schema or deferred skip rationale | oracle/deferred | office-vba | External oracle packet, not required in headless CI | `bd-9xmu.4.6` |
