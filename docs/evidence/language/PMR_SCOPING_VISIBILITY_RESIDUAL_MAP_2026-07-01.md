...
- Candidate for evidence-anchor refresh while remaining partial: no remaining
  row in this residual map is only a candidate. `bd-4ktq.38.2` through
  `bd-4ktq.38.5` own the concrete reconciliation decisions below.
