...
| `P4` | Qualified name handling in executable subset (module-qualified + same-project-qualified) | `compile_project_rewrites_module_qualified_calls_for_unique_names`; `compile_project_rewrites_same_project_qualified_call` |
