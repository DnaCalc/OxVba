...
| support | [REMAINING_RUNTIMEVALUE_PROJECTION_CLASSIFICATION_2026-04-27.md](/C:/Work/DnaCalc/OxVba/docs/evidence/value_model_migration/REMAINING_RUNTIMEVALUE_PROJECTION_CLASSIFICATION_2026-04-27.md) | classification evidence: remaining `RuntimeValue` projection surfaces and executable `vmm-e6` delivery paths |
