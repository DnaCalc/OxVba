...
| support | [BSTR_INTRINSIC_CLOSURE_CHECKLIST_2026-04-24.md](/C:/Work/DnaCalc/OxVba/docs/evidence/value_model_migration/BSTR_INTRINSIC_CLOSURE_CHECKLIST_2026-04-24.md) | checklist evidence: string/BSTR lane is intrinsically migrated with projected/bounded follow-ups classified |
| support | [VARIANT_SAFEARRAY_UNION_PAYLOAD_PROGRESS_2026-04-23.md](/C:/Work/DnaCalc/OxVba/docs/evidence/value_model_migration/VARIANT_SAFEARRAY_UNION_PAYLOAD_PROGRESS_2026-04-23.md) | progress evidence: `Variant` now stores `VT_ARRAY | VT_VARIANT` as a real `SAFEARRAY*`; `RuntimeValue` consolidation remains open |
| support | [VM_VARIANT_SLOT_AND_SAFEARRAY_DESCRIPTOR_PROGRESS_2026-04-23.md](/C:/Work/DnaCalc/OxVba/docs/evidence/value_model_migration/VM_VARIANT_SLOT_AND_SAFEARRAY_DESCRIPTOR_PROGRESS_2026-04-23.md) | progress evidence: VM registers now store `Variant` slots and ReDim arrays preserve typed SAFEARRAY descriptor state; carrier consolidation remains open |
| support | [REMAINING_RUNTIMEVALUE_PROJECTION_CLASSIFICATION_2026-04-27.md](/C:/Work/DnaCalc/OxVba/docs/evidence/value_model_migration/REMAINING_RUNTIMEVALUE_PROJECTION_CLASSIFICATION_2026-04-27.md) | final classification evidence: remaining `RuntimeValue` projection surfaces are compatibility contracts, not internal value storage |
| support | [VARIANT_SAFEARRAY_INTRINSIC_CLOSURE_CHECKLIST_2026-04-27.md](/C:/Work/DnaCalc/OxVba/docs/evidence/value_model_migration/VARIANT_SAFEARRAY_INTRINSIC_CLOSURE_CHECKLIST_2026-04-27.md) | current closure checklist for the Variant/SAFEARRAY intrinsic family |
