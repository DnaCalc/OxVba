...
| `COM-0004` | `verified` | remaining accepted scope | broader real-library activation authority remains open beyond the current registered-host subset | `bd-cyr.3.9` |
| `COM-0005` | `verified` | remaining accepted scope | broader dual-interface behavior remains open outside the mixed-server supported subset | `bd-cyr.3.9` |
| `COM-0006` | `verified` | remaining accepted scope | broader typelib/versioned-reference behavior remains open outside the current file-backed subset | `bd-cyr.3.9` |
