...
|---|---|---|---|---|
| COM-0010 | com_external | WrappedComServer source dispinterface and connection-point event publication | in-progress | docs/validation/COM_EXTERNAL_INTEGRATION_VALIDATION_MATRIX_V1.csv |
