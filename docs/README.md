...
| **Native-Ready Rebase Master** | [`worksets/WORKSET_2026-04-30_NATIVE_READY_REBASE_MASTER.md`](worksets/WORKSET_2026-04-30_NATIVE_READY_REBASE_MASTER.md) | Current umbrella program for docs truth, stale-code removal, value/type cleanup, correctness stress coverage, runner/perf scaffolding, and later direct native compilation. |
...
| Native-Ready RuntimeValue/IR Cleanout Workset | [`worksets/WORKSET_2026-04-30_RUNTIMEVALUE_IR_STUB_CLEANOUT.md`](worksets/WORKSET_2026-04-30_RUNTIMEVALUE_IR_STUB_CLEANOUT.md) | Workset for removing residual `RuntimeValue` and fake HIR/MIR/CFG scaffolds from active APIs. |
| Native-Ready Value Substrate Cleanup Workset | [`worksets/WORKSET_2026-04-30_VALUE_SUBSTRATE_NUMERIC_UDT_CLEANUP.md`](worksets/WORKSET_2026-04-30_VALUE_SUBSTRATE_NUMERIC_UDT_CLEANUP.md) | Workset for Variant-native numerics, exact carriers, UDT descriptors, and native ABI boundaries. |
| Native-Ready Correctness Corpus Workset | [`worksets/WORKSET_2026-04-30_CORRECTNESS_CORPUS_AND_ORACLE_STRESS.md`](worksets/WORKSET_2026-04-30_CORRECTNESS_CORPUS_AND_ORACLE_STRESS.md) | Workset for oracle-backed and implementation-defined stress tests before native compilation. |
| Native-Ready Runner/Perf Workset | [`worksets/WORKSET_2026-04-30_REFERENCE_RUNNERS_AND_PERF_SCAFFOLD.md`](worksets/WORKSET_2026-04-30_REFERENCE_RUNNERS_AND_PERF_SCAFFOLD.md) | Workset for shared VM/JIT/wrapper runner outputs and benchmark scaffolding. |
