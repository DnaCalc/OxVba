...
| **AutoRun State** | [`AUTORUN_STATE.md`](AUTORUN_STATE.md) | Active execution guardrail for continuous runs. Current target is the COM early-binding/type-library implementation gate `v426`; blocker handling follows `CURRENT_BLOCKERS.md`. |
