...
|---|---|---|
| **MACH-1000 Plan** | [`MACH1000_PLAN.md`](../MACH1000_PLAN.md) | Historical synthesis and project vision. Useful context, but no longer the definitive current implementation plan where it conflicts with active architecture/workset evidence. |
| **Native-Ready Rebase Master** | [`worksets/WORKSET_2026-04-30_NATIVE_READY_REBASE_MASTER.md`](worksets/WORKSET_2026-04-30_NATIVE_READY_REBASE_MASTER.md) | Current umbrella program for docs truth, stale-code removal, value/type cleanup, correctness stress coverage, runner/perf scaffolding, and later direct native compilation. Recovery audit 2026-05-02 reopens phases 3-5 for executable re-proof. |
| Native-Ready Docs Truth Workset | [`worksets/WORKSET_2026-04-30_DOCS_TRUTH_AND_ARCHIVE_REBASE.md`](worksets/WORKSET_2026-04-30_DOCS_TRUTH_AND_ARCHIVE_REBASE.md) | Workset for archiving/demoting old plans and keeping current docs aligned to implementation truth. |
| Native-Ready RuntimeValue/IR Cleanout Workset | [`worksets/WORKSET_2026-04-30_RUNTIMEVALUE_IR_STUB_CLEANOUT.md`](worksets/WORKSET_2026-04-30_RUNTIMEVALUE_IR_STUB_CLEANOUT.md) | Recovered-complete workset: active Rust source is clean for `RuntimeValue`/`runtime_value`, and fake HIR/MIR/CFG scaffolds are absent from active crate APIs. |
| Native-Ready Value Substrate Cleanup Workset | [`worksets/WORKSET_2026-04-30_VALUE_SUBSTRATE_NUMERIC_UDT_CLEANUP.md`](worksets/WORKSET_2026-04-30_VALUE_SUBSTRATE_NUMERIC_UDT_CLEANUP.md) | Reopened recovery workset for Variant-native numerics, exact carriers, UDT descriptors, and native ABI boundaries. |
| Native-Ready Correctness Corpus Workset | [`worksets/WORKSET_2026-04-30_CORRECTNESS_CORPUS_AND_ORACLE_STRESS.md`](worksets/WORKSET_2026-04-30_CORRECTNESS_CORPUS_AND_ORACLE_STRESS.md) | Reopened recovery workset for oracle-backed and implementation-defined stress tests before native compilation. |
| Native-Ready Runner/Perf Workset | [`worksets/WORKSET_2026-04-30_REFERENCE_RUNNERS_AND_PERF_SCAFFOLD.md`](worksets/WORKSET_2026-04-30_REFERENCE_RUNNERS_AND_PERF_SCAFFOLD.md) | Reopened recovery workset for shared VM/JIT/wrapper runner outputs and benchmark scaffolding. |
...
| VBP Subset + Artifact Strategy Discussion v1 | [`spec/VBP_SUBSET_AND_PROJECT_ARTIFACT_STRATEGY_DISCUSSION_V1.md`](spec/VBP_SUBSET_AND_PROJECT_ARTIFACT_STRATEGY_DISCUSSION_V1.md) | Design-draft discussion of immediate `.vbp` subset support, wrapper EXE/DLL packaging, and lateral options for loose/compiled execution artifacts. |
| Hosting/Project/Tooling Proposal (Canonical, v2 content) | [`spec/HOSTING_PROJECT_TOOLING_PROPOSAL.md`](spec/HOSTING_PROJECT_TOOLING_PROPOSAL.md) | Canonical hosting/project/packaging/tooling proposal with DNA VbCalc pathfinder host, `oxvba.toml` schema, complete CLI help text, WASM comparison, top-level code extension, embedding sketches, and phased execution plan. |
| Hosting/Project/Tooling Proposal v1 (Archived) | [`spec/archive/HOSTING_PROJECT_TOOLING_PROPOSAL_V1.md`](spec/archive/HOSTING_PROJECT_TOOLING_PROPOSAL_V1.md) | Archived original v1 proposal retained for historical traceability; superseded by the canonical proposal. |
| VBP Subset + Artifact Workset Plan | [`worksets/WORKSET_2026-03-05_VBP_SUBSET_AND_ARTIFACT_PLAN.md`](worksets/WORKSET_2026-03-05_VBP_SUBSET_AND_ARTIFACT_PLAN.md) | Execution-grade phased implementation plan for `VBP-S0` ingest, `A0` artifacts, wrapper EXE output, and in-process STA COM DLL wrapper lanes. |
| Events Story Completion Workset | [`worksets/WORKSET_2026-03-07_EVENTS_STORY_COMPLETION.md`](worksets/WORKSET_2026-03-07_EVENTS_STORY_COMPLETION.md) | Planned closure workset for `WithEvents`/`RaiseEvent`/`Implements`, embedded host event routing, and COM event bridge lanes (`COM-EVT-A` + `COM-EVT-B`). |
| Events Runtime HostProject+HAL Workset | [`worksets/WORKSET_2026-03-08_EVENTS_RUNTIME_HOST_PROJECT_HAL_SPLIT.md`](worksets/WORKSET_2026-03-08_EVENTS_RUNTIME_HOST_PROJECT_HAL_SPLIT.md) | Continuation workset focused on runtime event execution closure under Host Project semantic ownership, mandatory HAL services/policy gates, and cross-platform non-COM pathfinder validation. |
| Events Parity Closure Workset | [`worksets/WORKSET_2026-03-08_EVENTS_PARITY_CLOSURE.md`](worksets/WORKSET_2026-03-08_EVENTS_PARITY_CLOSURE.md) | Active parity-closure work item defining the full design+implementation path from EVR baseline to VBA-class event/runtime parity and divergence/deferred-gate closure. |
...
| Work Set Plan (v417-v426) | [`worksets/WORKSET_2026-03-05_COM_EARLY_BINDING_TYPELIB_IMPLEMENTATION_V417_V426.md`](worksets/WORKSET_2026-03-05_COM_EARLY_BINDING_TYPELIB_IMPLEMENTATION_V417_V426.md) | Implementation block-I workset for PMR/HAL/binder/runtime early-binding bridge foundation. |
| Work Set Plan (v427-v445) | [`worksets/WORKSET_2026-03-05_COM_EARLY_BINDING_TYPELIB_IMPLEMENTATION_V427_V445.md`](worksets/WORKSET_2026-03-05_COM_EARLY_BINDING_TYPELIB_IMPLEMENTATION_V427_V445.md) | Implementation block-II workset for strategy controls, lane execution, diagnostics hardening, performance, and robustness passes. |
| Work Set Plan (v446-v457) | [`worksets/WORKSET_2026-03-05_COM_EARLY_BINDING_TYPELIB_ORACLE_FORMAL_V446_V457.md`](worksets/WORKSET_2026-03-05_COM_EARLY_BINDING_TYPELIB_ORACLE_FORMAL_V446_V457.md) | Oracle/formal tranche workset for deferred-gate policy, CI lane integration, and foldback scaffolding. |
| Work Set Plan (v458-v466) | [`worksets/WORKSET_2026-03-05_COM_EARLY_BINDING_TYPELIB_CLOSURE_V458_V466.md`](worksets/WORKSET_2026-03-05_COM_EARLY_BINDING_TYPELIB_CLOSURE_V458_V466.md) | Terminal closure tranche with integrated gate rehearsal/run and ladder completion artifacts. |
| Work Set Plan (v407-v466) | [`worksets/WORKSET_2026-03-05_COM_EARLY_BINDING_TYPELIB_EXECUTION_V407_V466.md`](worksets/WORKSET_2026-03-05_COM_EARLY_BINDING_TYPELIB_EXECUTION_V407_V466.md) | Aggregate execution artifact for full COM early-binding/type-library ladder completion through `v466`. |
| Work Set Plan (Post-v466 Process Hardening) | [`worksets/WORKSET_2026-03-05_PROCESS_HARDENING_SERIES_POST_V466.md`](worksets/WORKSET_2026-03-05_PROCESS_HARDENING_SERIES_POST_V466.md) | Operational hardening ladder for no-artifact validation, run-id stability, commit/profile guardrails, evidence retention, gate manifests, and formal JSONL reporting. |
