...
| **AutoRun State** | [`AUTORUN_STATE.md`](AUTORUN_STATE.md) | Active execution guardrail for continuous runs. Current target is the COM early-binding/type-library terminal gate `v466`; blocker handling follows `CURRENT_BLOCKERS.md`. |
...
| Hosting/Project/Tooling Proposal v1 | [`spec/HOSTING_PROJECT_TOOLING_PROPOSAL_V1.md`](spec/HOSTING_PROJECT_TOOLING_PROPOSAL_V1.md) | Initial design proposal for embedded hosting, add-in semantics, project/artifact formats, modern CLI flows, event-model closure, XLL prototyping, and WASM/security strategy. Superseded by V2. |
| Hosting/Project/Tooling Proposal v2 | [`spec/HOSTING_PROJECT_TOOLING_PROPOSAL_V2.md`](spec/HOSTING_PROJECT_TOOLING_PROPOSAL_V2.md) | Expanded hosting/project/packaging/tooling proposal with DNA VbCalc pathfinder host, `oxvba.toml` schema, complete CLI help text, WASM comparison, top-level code extension, embedding sketches, and phased execution plan. |
