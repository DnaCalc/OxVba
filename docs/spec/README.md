...
- [`HOSTING_PROJECT_TOOLING_PROPOSAL_V1.md`](HOSTING_PROJECT_TOOLING_PROPOSAL_V1.md) (`design-draft`): initial comprehensive proposal for embedded hosting, add-in/runtime packaging, modern project/CLI model, event-hook closure strategy, Excel XLL prototyping, and WASM/security posture. Superseded by V2.
- [`HOSTING_PROJECT_TOOLING_PROPOSAL_V2.md`](HOSTING_PROJECT_TOOLING_PROPOSAL_V2.md) (`design-draft`): expanded hosting/project/packaging/tooling proposal with full DNA VbCalc pathfinder host design, `oxvba.toml` schema, complete CLI help text, WASM comparison, top-level code extension, programmatic embedding sketches, and phased execution plan. Supersedes V1.
