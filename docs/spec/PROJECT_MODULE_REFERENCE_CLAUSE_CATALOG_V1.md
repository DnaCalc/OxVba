...
| `PMR-VIS-002` | visibility | Colliding public variable names require module qualification (`CONF-...-0053`). | implemented-partial | `public_symbol_collisions_require_qualification`; `public_const_variable_collision_should_be_ambiguous`; `public_const_variable_collision_keeps_module_qualified_access`; `public_const_variable_collision_keeps_project_qualified_access` |
...
| `PMR-NAME-001` | name-resolution | Cross-module collision rules for module-level declarations are enforced (`CONF-...-0131/0132/0136`). | implemented-partial | existing module-local collision tests; `public_const_variable_collision_should_be_ambiguous`; `public_const_variable_collision_keeps_module_qualified_access`; `public_const_variable_collision_keeps_project_qualified_access` |
...
| `PMR-NAME-003` | name-resolution | Project/module/reference namespace precedence is deterministic and documented. | implemented-partial | `compile_project_rewrites_module_qualified_calls_for_unique_names`; `compile_project_rewrites_same_project_qualified_call`; `active_project_resolution_uses_reference_precedence_order_for_shadowing`; `referenced_project_precedence_and_project_qualifier_are_explicit`; `active_project_member_shadows_referenced_project_member`; `wrong_referenced_project_qualifier_should_be_rejected`; `duplicate_referenced_project_global_name_should_be_ambiguous`; `duplicate_referenced_project_global_name_blocks_later_reference_fallback` |
| `PMR-CLS-001` | class | `WithEvents` declarations are prohibited in procedural module declaration lists (`CONF-...-0056`). | implemented-verified | `compile_project_rejects_withevents_in_procedural_module`; `compile_project_allows_withevents_in_class_module`; `scanner_rejects_withevents_in_standard_modules`; `withevents_in_procedural_module_should_be_rejected` |
