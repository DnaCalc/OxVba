...
- [x] Refine adapter implementations to satisfy the tightened contract and rerun evidence suite.
- [x] Update project references/logs and summarize resulting HAL operating envelope and open uncertainties.
