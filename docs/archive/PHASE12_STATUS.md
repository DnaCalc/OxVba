...
- Required matrix cells for declared profile scope are green.
  - Evidence artifact: `docs/evidence/profiles/v146/matrix_latest.csv`
  - Gate report: `docs/evidence/profiles/v146/gate_report.md`
- Integrated correctness/performance gate is green.
  - Integrated report: `docs/evidence/profiles/v146/integrated_gate.md`
  - Benchmark artifacts: `docs/evidence/profiles/v146/benchmark_latest.md`, `docs/evidence/profiles/v146/benchmark_latest.csv`
...
- Deferred strict formal lanes are reconciled through foldback or explicit defer with unblock steps.
  ...
  - Terminal audit: `docs/evidence/formal/DG_AUDIT_V86.md` (historical) plus `DG-V146-*` entries for current ladder scope.
...
Latest recorded integrated gate (`docs/evidence/profiles/v146/integrated_gate.md`): `PASS`.
