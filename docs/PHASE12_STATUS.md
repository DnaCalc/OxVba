...
- Profile: `mvp-full-coverage-perf-gate-v36`
...
- Required matrix cells for declared profile scope are green.
  - Evidence artifact: `docs/evidence/profiles/v36/matrix_latest.csv`
  - Gate report: `docs/evidence/profiles/v36/gate_report.md`
...
Latest recorded gate report (`docs/evidence/profiles/v36/gate_report.md`, 2026-02-27T21:24:29Z UTC): `PASS`.
