...
- **VBA-Web**: first pass gathered upstream at commit
  ...
  selected pure helpers with `Excel.Application` supplied by the host profile; Dictionary-backed
  runtime cases remain normal live-COM lanes rather than portable host shims. Blocked adjacent
  cases are cataloged as VW-15/VW-16/VW-18 and later rows.
