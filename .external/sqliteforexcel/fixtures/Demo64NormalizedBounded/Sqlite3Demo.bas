...
Private Const API_CALL_SPEED_ITERATIONS As Long = 1000
Private Const BINDING_INSERT_ITERATIONS As Long = 1000
Private Const BINDING_SELECT_ITERATIONS As Long = 1000
Private Const BINDING_SELECT_OFFSET_SPAN As Long = 100
Private Const BINDING_MORE_INSERT_ITERATIONS As Long = 1000
Private Const BINDING_MORE_SELECT_ITERATIONS As Long = 1000
Private Const BINDING_MORE_OFFSET_SPAN As Long = 100
...
Public Sub TestApiCallSpeed()
    ...
    start = Now()
    For i = 0 To API_CALL_SPEED_ITERATIONS
...
Public Sub TestBinding()
    ...
    For i = 1 To BINDING_INSERT_ITERATIONS
        curDate = startDate + i
        curValue = Rnd() * 1000
    ...
    For i = 1 To BINDING_SELECT_ITERATIONS
        offset = i Mod BINDING_SELECT_OFFSET_SPAN
        ' Bind the parameters
...
Public Sub TestBindingMore()
    ...
    For i = 1 To BINDING_MORE_INSERT_ITERATIONS
        curDate = startDate + i
        curValue = Rnd() * 1000
    ...
    For i = 1 To BINDING_MORE_SELECT_ITERATIONS
        offset = i Mod BINDING_MORE_OFFSET_SPAN
        ' Bind the parameters
