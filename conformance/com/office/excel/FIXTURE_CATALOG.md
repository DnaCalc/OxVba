...
| `OFFICE-COM-019` | `excel_range_default_member_put_smoke.bas` | Indexed Excel `Range("A1")(1)` default-member property-put observed through named-argument `Cells.Find`. | environment-dependent |
