...
| `OFFICE-COM-008` | `excel_workbook_range_smoke.bas` | Workbook collection, workbook creation, worksheet indexing, close, and cleanup; range/default-member value access remains open despite the legacy filename. | environment-dependent |
