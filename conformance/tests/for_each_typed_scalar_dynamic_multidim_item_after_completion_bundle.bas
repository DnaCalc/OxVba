Sub Main()
    ...
    ReDim abool(1 To 2, 1 To 2)
    ReDim abyte(1 To 2, 1 To 2)
    ReDim ai(1 To 2, 1 To 2)
    ReDim al(1 To 2, 1 To 2)
    ReDim all(1 To 2, 1 To 2)
    ReDim asng(1 To 2, 1 To 2)
    ReDim adbl(1 To 2, 1 To 2)
    ReDim acur(1 To 2, 1 To 2)
    ReDim adate(1 To 2, 1 To 2)
    ReDim astr(1 To 2, 1 To 2)
