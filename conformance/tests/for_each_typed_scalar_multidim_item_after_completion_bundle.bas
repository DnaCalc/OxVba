Sub Main()
    Dim score As Long
    Dim item
    Dim abool(1 To 2, 1 To 2) As Boolean
    Dim abyte(1 To 2, 1 To 2) As Byte
    Dim ai(1 To 2, 1 To 2) As Integer
    Dim al(1 To 2, 1 To 2) As Long
    Dim all(1 To 2, 1 To 2) As LongLong
    Dim asng(1 To 2, 1 To 2) As Single
    Dim adbl(1 To 2, 1 To 2) As Double
    Dim acur(1 To 2, 1 To 2) As Currency
    Dim adate(1 To 2, 1 To 2) As Date
    Dim astr(1 To 2, 1 To 2) As String
