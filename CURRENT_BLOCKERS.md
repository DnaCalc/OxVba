...
- Current state:
  ...
  - controlled/native result conversion now also accepts `VT_I2`, `VT_I4`, `VT_UI1`, `VT_UI2`, and `VT_UI4` into the current integer-token lane,
  - controlled/native result conversion now also accepts one-dimensional typed SAFEARRAY results with `VT_I2`, `VT_I4`, `VT_UI1`, `VT_UI2`, `VT_UI4`, `VT_BOOL`, and `VT_BSTR` element payloads into `RuntimeValue::ArrayIntent`,
