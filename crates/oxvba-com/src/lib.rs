...
pub use windows_test_dispatch::{
    ...
    DUAL_INTEGER_VALUE, DUAL_LONGLONG_VALUE, DUAL_PRICE_SCALED_I64, DUAL_SINGLE_VALUE,
    ...
    DUAL_SLOT_GET_OWNER, DUAL_SLOT_GET_PRICE, DUAL_SLOT_GET_SINGLE_VALUE, DUAL_SLOT_GET_TEXT_VALUE,
    ...
    DUAL_TEXT_VALUE, DUAL_VARIANT_VALUE, IID_OXVBA_DUAL_FIXTURE, create_oxvba_dual_vtable_object,
};
#[cfg(all(target_os = "windows", any(test, feature = "fixture-typelibs")))]
pub use windows_test_dispatch::{
