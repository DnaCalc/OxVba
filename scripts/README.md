...
- `run-formal-kani-remote.ps1`: remote Linux deferred-lane manager for Kani (`Ensure`/`ProbeCapacity`/`StartDeferred`/`Status`/`Tail`/`FetchArtifacts`) under `/home/ubuntu/.dnacalc_remote`.
