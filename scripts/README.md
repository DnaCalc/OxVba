...
- `run-com-registered-early-bound.ps1`: runs the real registered early-bound anchor lane (`com_early_project_end_to_end::early_bound_project_executes_registered_scripting_dictionary_anchor`, ignored test) and emits lane artifacts.
